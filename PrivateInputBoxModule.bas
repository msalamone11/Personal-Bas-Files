Attribute VB_Name = "PrivateInputBoxModule"
Option Explicit 'This module is used for the "InputBoxDK" function that allows you to mask the user's input when they are enting in their password.
